        ...
        <div class="content-wrapper">
            ...
            <header class="main-header" style="background: #bedaeb">
                ...
                <a href="#" class="logo">
                    ...
                    <span class="logo-lg"><b>Garai.com</b></span>
                </a>
                    ...
                    <div class="box box-primary direct-chat direct-chat-primary">
                        ...
                        <div class="box-body">
                            ...
                            <div class="box-body" id="chat-box">
                                ...
                                <div id="divChatWindow" class="direct-chat-messages" style="height: 300px;">
                                </div>
                        ...
                        <div class="box-footer">
                            <div class="form-group">
                              <textarea   class="form-control" placeholder="Message Typing..." id="txtMessage" name="txtMessage" rows="1" cols="50" runat="server"></textarea>
                            ...
                            <div class="input-group" style="float: right;">
                              ...
                              <%--  <span class="input-group-btn">
                                ...
                                <%--<span>
                                    <asp:Button ID="btnSendMsg" runat="server" OnClick="btnSendMsg_ServerClick" class="btn btn-primary btn-flat" Text="Send" /><br />

                                </span>--%>
                                
                                <span>
                                    <button type="button" id="btnSendMsg"  class="btn btn-primary btn-flat"  runat="server" onserverclick="btnSendMsg_ServerClick" >Send</button>
                                </span>
